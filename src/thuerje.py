...
def build_your_own_pizza():
    ...
    crust_button['command'] = (lambda: crust_frame(pizza_window))
    crust_button.grid()

    sauce_button = ttk.Button(frame, text='Sauce')
    sauce_button['command'] = (lambda: sauce_frame(pizza_window))
    sauce_button.grid()

    cheese_button = ttk.Button(frame, text='Cheese')
    cheese_button['command'] = (lambda: cheese_frame(pizza_window))
    cheese_button.grid()

    toppings_button = ttk.Button(frame, text='Toppings')
    toppings_button['command'] = (lambda: toppings_frame(pizza_window))
